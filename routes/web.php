...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/apiJasa', 'JasaController@apiJasa')->name('api.jasa');
	...
	Route::resource('penjualanJasa', 'PenjualanJasaController');
	Route::get('/apiPenjualanJasa', 'PenjualanJasaController@apiPenjualanJasa')->name('api.penjualanJasa');
	Route::get('/exportPenjualanJasaAll', 'PenjualanJasaController@exportPenjualanJasaAll')->name('exportPDF.penjualanJasaAll');
	Route::get('/exportPenjualanJasa/{id}', 'PenjualanJasaController@exportPenjualanJasa')->name('exportPDF.penjualanJasa');
